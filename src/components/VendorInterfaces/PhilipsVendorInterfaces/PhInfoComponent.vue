<template>
  <div class="full-card">
    <v-tabs v-model="currentActiveTab" :show-arrows="false" v-if="localSoftwareVersionPreference === 'r57'">
        ...
        <v-row class="criteria_area row-layout" align="start" justify="space-between">
          ...
          <v-col cols="6">
            <v-card class="small-card pt-2 pb-2 scan-view-options pa-3">
              ...
              <v-card-text class="pt-0 pl-0 question-content">
              ...
              <div>
                <v-col class="flex mt-2 mb-2">
                  <v-select
                    ...
                    :class="answersSelections.length > 1 ? 'custom_bordered' : ''"
...
::v-deep .v-input__slot .v-select__selections span {
  width: 300px !important;
}
::v-deep .v-input__slot .v-select__selections input {
...
@keyframes glow-animation {
  0% {
    box-shadow: 0 0 5px 2px rgb(235, 136, 8); /* Initial glow */
  }
  50% {
    box-shadow: 0 0 7px 5px rgb(235, 136, 8); /* Stronger glow */
  }
  100% {
    box-shadow: 0 0 5px 2px rgb(235, 136, 8); /* Back to initial glow */
  }
}
...
/* UPDATED BY ME */
.custom_bordered {
  border: 2px solid rgb(235, 136, 8);
  box-shadow: 0 0 2px 2px rgb(235, 136, 8); /* Add glowing effect */
  animation: glow-animation 1.5s infinite alternate; /* Add animation */
}
