<template>
  ...
  >
    <div class="main-content">
      ...
      <div class="content">
        <div class="label"><span>Copy Rx List</span></div>
        <div class="options">
          <v-table>
            <thead>
              <tr>
              ...
              <tbody>
                ...
                >
                  ...
                  <td width="234px" style="display: flex; padding-left: 5px">
                    {{
                      stackQuestions && stackQuestions[isActive] && stackQuestions[isActive].questionText
...
export default {
  ...
  async mounted() {
    this.initialPosY = window.innerHeight / 2 + 106 // Store the initial position after mounting
    ...
    this.isActive = this.selectedStackQuestionIndexVisual - 1
  },
  methods: {
    startDrag(e) {
    ...
    handleOK() {
      ...
      this.forcedIsCopyRxWidgetActive = false
      this.emitCopyRxAction = true
    },
    handleClose() {
      this.closeToolbar = false
      this.forcedIsCopyRxWidgetActive = false
