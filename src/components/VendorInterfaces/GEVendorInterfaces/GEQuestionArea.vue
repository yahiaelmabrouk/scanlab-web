<template>
  <div class="full-card">
    <div v-if="questionSet && !isEditingQuestion && !isAddLocalizerMode" class="tab-1">
      <!-- Row-wise alignment ke liye v-row aur v-col use kiya -->
      <div class="criteria_area row-layout" align="start" justify="space-between">
        ...
        <div style="height: 35%">
          <v-card class="small-card pt-2 pb-2 scan-view-options pa-3">
            <v-card-title class="flex justify-space-between align-center">
              ...
              <v-row justify="end" class="mr-1" v-if="stackQuestionsLength > 1">
                <div class="mr-2 cycle-question-button" @click="handleBackQuestion">
                  <img
                ...
                <div class="cycle-question-button" @click="handleNextQuestion">
                  <img
            ...
            <v-card-text class="pt-0 pb-0 question-content">
        ...
        <div style="height: 65%">
          <v-card class="small-card pt-2 pb-2 scan-view-options pa-3">
            ...
            <v-row class="d-flex align-center pt-0">
              <v-col class="flex" style="padding: 3px 15px 3px 15px">
                <v-select
                  outlined
                  hide-details
              ...
              <v-card-text class="pt-0 pt-2 pb-0 answer-content">
                <v-row class="pt-0 truncated-field pb-0">
                  <TranslatedContent
                    type="stackQuestion"
                ...
                <v-row
                  class="pt-0 pb-0 truncated-strong d-flex flex-wrap"
...
export default {
  ...
  methods: {
    ...
    handleBackQuestion() {
      // let currentIndex = this.selectedStackQuestionIndexVisual
      // if (this.stackQuestions[currentIndex - 2].description === '3-Plane Localizer') {
      //   if (currentIndex <= 2) {
      //     currentIndex = currentIndex + this.stackQuestionsLength;
      //   }
    ...
    handleNextQuestion() {
      // let currentIndex = this.selectedStackQuestionIndexVisual
      // if (this.stackQuestions[currentIndex].description === '3-Plane Localizer') {
      //   if (currentIndex >= this.stackQuestionsLength - 1) {
      //     currentIndex = currentIndex - this.stackQuestionsLength;
      //   }
